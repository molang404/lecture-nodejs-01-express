...
router.get("/posts/:id", (req, res) => {
    ...
    });          // 일치하는 게 있으면 그 value가 반환되고, 없으면 undefined
    ...
    if (!result) {
        ...
        // 우리가 json() 안에 매개변수에 넣어준 건, 자바스크립트 객체 => JSON 문법이 아니라 js 문법
    }
    res.json(
        { data: result }
    );
